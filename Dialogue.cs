...
namespace CaveAdventure
{
    public partial class Dialogue {
        public void Billy() { // Dialogue for Billy
        ...
        public void Bartender(string error = "") { // Because every tavern needs a bartender
        ...
        public void HangMan() {
            ...
            if (GamePlay.HangmanKey == true) { // You've won medium already
                GMdialogue = "";
            }
