...
namespace CaveAdventure
{
    ...
    public partial class GamePlay
    {
        ...
        { // Used to await user input to continue code, good for forcing user to read
        ...
        { // Environment used the most
            ...
            { // Actually has no function, just for fun
            ...
            { // Forces the hidden thief encounter
        ...
        public static void Cave()
        {
            ...
            if (BillyKey == true && HangmanKey == true && MathKey == true && GraveKey == true && BraveKey == true)
            { // End of game
...
%%%%
        ...
        public static void Tavern()
        {
            ...
            Console.Clear();
            if (Billy == 3)
            { // Clear billy option when his quest is complete
                billyOption = "";
            }
            ...
            else if (option.Contains("exit") || option.Contains("back"))
            {
                ...
                if (ThievesEncounter == 0)
                { // Random encounter chance to run into the thief encounter
                    var chance = new Random().Next(0, 10);
                    if (chance > 5 || option.Contains("random"))
                    { // If lucky or user forced the random option, go to thief scenario
                        new ThiefEncounter().Thief();
                    }
                    else
                    {
        ...
        public static void Graveyard()
        {
            ...
            { // Whistle to find Billy's dog nessie
