...
public partial class ThiefEncounter
{
    public void Thief()
    {
        ...
        void GameStart()
        {
            ...
            if (UserChoice != "rock" && UserChoice != "paper" && UserChoice != "scissor" && UserChoice != "cheat")
        ...
        "scissor"
            ...
            if (rounds > 5)
            { // If we've played more than 5 rounds, make the game predictable
                ...
                if (notRandom == 4)
                { // If we were to roll around to four, go back to one, as we only have 3 things in the list
                    notRandom = 1;
                }

            }
            else
            { // If less than 5 rounds played, pick one randomly
